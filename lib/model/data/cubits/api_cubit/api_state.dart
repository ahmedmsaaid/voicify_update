...
final class LoadingPickVideoFile extends ApiState {}

final class SuccessPickVideoFile extends ApiState {}

final class FailedPickVideoFile extends ApiState {
  final String msg;

  FailedPickVideoFile({required this.msg});
}
